...
rver <- 'C:/Users/fdalb/AppData/Local/R/win-library/4.3/ALFAM2-versions/R-ver'
cver <- 'C:/Users/fdalb/AppData/Local/R/win-library/4.3/ALFAM2-versions/C-ver'
ref_loc <- 'C:/Users/fdalb/AppData/Local/R/win-library/4.3'
...
# devtools::install_github('sashahafner/ALFAM2@v3.17', ref = 'Rcpp-dev', lib = ref_loc, force = TRUE)
...
# Export results
write.csv(times, '../output/times_win_fast.csv')
write.csv(cv, '../output/cv_win_fast.csv')
